...
if has("autocmd")
  ...
  "
  " Para LaTeX - tex - latex
  au FileType tex  imap Ç \c{C}
  au FileType tex  imap ç \c{c}
  au FileType tex  imap Á \'{A}
  au FileType tex  imap À \`{A}
  au FileType tex  imap Â \^{A}
  ...
  au FileType tex  imap ú \'{u}
  au FileType tex  imap Ü \"{U}
  au FileType tex  imap ü \"{u}
  au FileType tex  map <C-c> 0i% <Esc>
  au FileType tex  map <F4> <C-c>j<C-c>j<C-c>j<C-c>j<C-c>n
  au FileType tex  map <C-x> 0xx
  au FileType tex  map <F12> :w<CR>:!pdflatex %<CR>
